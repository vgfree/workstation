...
local function myfunction(body)
	...
	local data = "POST /deletecollectionnewsbyid HTTP/1.0\r\n" ..
...
function readyes()
	...
	--local body = '{"maxRecords":"50","yes":"1","curPage":"1","sign":"184446D6FBCB17CF9F2AE3C0C4AE68BD76AD0563","userid":"eB6bYE8pkl","appKey":"1313750614"}'
